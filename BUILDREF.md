...
| `installer_resumes` | One resume per installer. Stores all resume sections and template settings | `selected_template`, `accent_color`, `show_photo`, `content_visibility`, `unresolved_flag_count`, `auto_hidden_at` |
