...
| `/api/company/team/invite` | POST | Required | `inviteTeamMemberSchema` | Send team invitation |
...
| Admin invitations | `/invite/[token]` | Admin-only send via `/api/invitations/send` |
...
| Company team API routes | Phase C | `/api/company/team/invite`, `/members`, `/leave`, `/api/company/invitations/revoke` |
